...
public class VerifyCodeUtils {
	...
	public static void outputImage(int w, int h, OutputStream os, String code) throws IOException{
		outputImage(w, h, os, code,0);
	}
	
	public static void outputImage(int w, int h, OutputStream os, String code,int padding)
			throws IOException {
		...
		for (int i = 0; i < verifySize; i++) {
			...
			g2.drawChars(chars, i, 1, ((w - 10 - padding) / verifySize) * i + 5, h / 2
					+ fontSize / 2 - 10);
	...
	public static void outputImageToStream(int w, int h, OutputStream out, String code){
		if (out == null) {
			return;
		}
		try {
