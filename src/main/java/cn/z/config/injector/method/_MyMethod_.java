 ...
 */
public class _MyMethod_ extends AbstractMethod {
  ...
  public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
    ...
    for (Type t : mapperClass.getGenericInterfaces()) {
      ...
      Type types[] =  pt.getActualTypeArguments();  // 获取参数化类型中，实际类型的定义 【new Type[]{Dept.class}】
      // ArrUtil.outln(types);  //[class cn.z.entity.Dept]
      Class clazz = (Class) types[0];  // 获取数据的第一个元素：Dept.class
